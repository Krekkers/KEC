...
public class ItemMaker {
    public static ItemStack checkpointItem = createCustomItem(
            Material.matchMaterial(config.getString("parkoursettings.items.goback.backmaterial")),
            1,
            ChatColor.translateAlternateColorCodes('&' , config.getString("parkoursettings.items.goback.backitemname"))
    );
